  ...
  async addBubble() {
    ...
    const bbs = () => {
      ...
      if (alpha > 0) {
        ...
        window.requestAnimationFrame(bbs);
      }

      // this.bubbleCtx.save();
      // this.bubbleCtx.beginPath();
      // this.bubbleCtx.rect(nextx, nexty, width * 3, height * 3);
      // this.bubbleCtx.translate(nextx + (width * 3) / 2, nexty + (height * 3) / 2);
      // this.bubbleCtx.scale(this.ratio, this.ratio);
      // // this.bubbleCtx.rotate(this.angle);
      // this.bubbleCtx.drawImage(bubbleImg, nextx, nexty, width * 3, height * 3);
      // this.bubbleCtx.strokeStyle = "transparent";
