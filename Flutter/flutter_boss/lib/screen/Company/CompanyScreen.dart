...
import 'package:flutter_boss/components/company_item.dart';
import 'package:flutter_boss/model/company.dart';
import 'package:flutter_boss/screen/Company/CompanyDetail.dart';
...
class _CompanyScreenState extends State<CompanyScreen> {
  ...
  getCompanyList() {
    setState(() {
      _companyList = Company.fromJson(jsonData);
    });
  }
...
var jsonData = """
          {
            "list": [
              ...
              },
              {
                ...
                "hot": "前端架构师",
                "count": "400",
                "inc": "平安银行，全称平安银行股份有限公司，是中国平安保险（集团）股份有限公司控股的一家跨区域经营的股份制商业银行，为中国大陆12家全国性股份制商业银行之一，总部位于广东省深圳市。中国����保险（集团）股份有限公司（以下简称“中国平安”）及其控股子公司为平安银行的控股股东。"
              },
              {
                ...
                "hot": "IOS工程师",
                "count": "200",
                "inc": "蘑菇租房是国内领先的真实租房平台，2014���蘑菇租房从品牌长租公寓起步，蘑菇租房的前身蘑菇公寓致力于为都市白领创造高品质居住生活。"
              }
            ]
          }
      """;
